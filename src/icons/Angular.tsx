...
const SvgAngular = (props: SVGProps<SVGSVGElement>) => (
  <svg className="angular_svg__icon" viewBox="0 0 128 128" {...props}>
    <path
      fill="#a6120d"
    ...
    <path
      fill="#a6120d"
      d="M117.536 25.998 63.672 7.629v112.785l45.141-24.983zM11.201 26.329l8.026 69.434 44.444 24.651V7.627z"
    />
    <path
      fill="#fff"
